...
class SubtitleStoreTest {
    @Test
    fun denseCaptionsHaveAHardEntryCapAndIncludePlaybackAfterLargeSeeks() = runBlocking {
    ...
    @Test
    fun diskRoundTripPreservesWordsIdsAndUnicode() = runBlocking {
    ...
    @Test
    fun emptyTrackAndSilenceAreSafe() = runBlocking {
    ...
    @Test
    fun closingAStoreDeletesItsTranscriptFile() = runBlocking {
    ...
    private suspend fun withStore(rows: List<SubtitleSegment>, block: suspend (SubtitleStore) -> Unit) {
