...
- Enforce a full-width 16:9 player on portrait watch pages without cropping the video, using the live video container chain so YouTube layout changes do not leave the player compressed.
